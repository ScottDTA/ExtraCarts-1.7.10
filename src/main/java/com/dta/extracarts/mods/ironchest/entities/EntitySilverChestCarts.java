...
public class EntitySilverChestCarts extends EntityExtraCartsChestMinecart implements OpenableGUI, IMinecart, IItemTransfer {
	...
	public EntitySilverChestCarts(World world) {
		super(world);
	...
	public boolean interactFirst(EntityPlayer player) {
		...
		if (curItem !=null && curItem.getItem() == SilverGoldUpgrade) {
			EntityGoldChestCarts goldCart = new EntityGoldChestCarts(player.worldObj);
	...
	public boolean doesCartMatchFilter(ItemStack stack, EntityMinecart cart) {
		...
		if (cart instanceof EntitySilverChestCarts && stack.getItem() == CartStack.getItem() && stack.getItemDamage() == 4) {
				return true;
		}
		return false;
	}
