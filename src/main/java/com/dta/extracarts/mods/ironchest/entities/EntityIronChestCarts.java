...
public class EntityIronChestCarts extends EntityExtraCartsChestMinecart implements OpenableGUI, IMinecart, IItemTransfer {
	...
	public EntityIronChestCarts(World world) {
		super(world);
	...
	public boolean doesCartMatchFilter(ItemStack stack, EntityMinecart cart) {
		...
		if (cart instanceof EntityIronChestCarts && stack.getItem() == CartStack.getItem() && stack.getItemDamage() == 0) {
				return true;
		}
		return false;
	}
