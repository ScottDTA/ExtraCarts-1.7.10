...
public class EntityDiamondChestCarts extends EntityExtraCartsChestMinecart implements OpenableGUI, IMinecart, IItemTransfer {
	...
	public EntityDiamondChestCarts(World world) {
		super(world);
	...
	public boolean interactFirst(EntityPlayer player) {
		...
		if (curItem !=null && curItem.getItem() == DiamondCrystalUpgrade) {
			EntityCrystalChestCarts crystalCart = new EntityCrystalChestCarts(player.worldObj);
		...
		if (curItem !=null && curItem.getItem() == DiamondObsidianUpgrade) {
			EntityObsidianChestCarts obsidianCart = new EntityObsidianChestCarts(player.worldObj);
	...
	public boolean doesCartMatchFilter(ItemStack stack, EntityMinecart cart) {
		...
		if (cart instanceof EntityDiamondChestCarts && stack.getItem() == CartStack.getItem() && stack.getItemDamage() == 2) {
				return true;
		}
		return false;
	}
