...
public class EntityGoldChestCarts extends EntityExtraCartsChestMinecart implements OpenableGUI, IMinecart, IItemTransfer {
	...
	public EntityGoldChestCarts(World world) {
		super(world);
	...
	public boolean interactFirst(EntityPlayer player) {
		...
		if (curItem !=null && curItem.getItem() == GoldDiamondUpgrade) {
			EntityDiamondChestCarts diamondCart = new EntityDiamondChestCarts(player.worldObj);
	...
	public boolean doesCartMatchFilter(ItemStack stack, EntityMinecart cart) {
		...
		if (cart instanceof EntityGoldChestCarts && stack.getItem() == CartStack.getItem() && stack.getItemDamage() == 1) {
				return true;
		}
		return false;
	}
