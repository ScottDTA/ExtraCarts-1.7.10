 ...
 */
public class EntitySimpleCapacitorBankCart extends EntityCapacitorBankCart {
	...
	public EntitySimpleCapacitorBankCart(World world) {
		super(world, 0);
	}

	public EntitySimpleCapacitorBankCart(World world, int energy) {
		super(world, energy);
	}
